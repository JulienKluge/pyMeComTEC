...
class _MeerstetterTEC_autogen:
    ...
    def COM_DeviceType(self, channel = 1):
        return self.read_value(100, MeParType.INT32, channel)

    def COM_HardwareVersion(self, channel = 1):
        return self.read_value(101, MeParType.INT32, channel)

    def COM_SerialNumber(self, channel = 1):
        return self.read_value(102, MeParType.INT32, channel)

    def COM_FirmwareVersion(self, channel = 1):
        return self.read_value(103, MeParType.INT32, channel)

    def COM_DeviceStatus(self, channel = 1):
        return self.read_value(104, MeParType.INT32, channel)

    def COM_ErrorNumber(self, channel = 1):
        return self.read_value(105, MeParType.INT32, channel)

    def COM_ErrorInstance(self, channel = 1):
        return self.read_value(106, MeParType.INT32, channel)

    def COM_ErrorParameter(self, channel = 1):
        return self.read_value(107, MeParType.INT32, channel)
    ...
    def TEC_ObjectTemperature(self, channel = 1):
        return self.read_value(1000, MeParType.FLOAT32, channel)

    def TEC_SinkTemperature(self, channel = 1):
        return self.read_value(1001, MeParType.FLOAT32, channel)

    def TEC_TargetObjectTemperature(self, channel = 1):
        return self.read_value(1010, MeParType.FLOAT32, channel)

    def TEC_RampNominalObjectTemperature(self, channel = 1):
        return self.read_value(1011, MeParType.FLOAT32, channel)

    def TEC_ThermalPowerModelCurrent(self, channel = 1):
        return self.read_value(1012, MeParType.FLOAT32, channel)

    def TEC_ActualOutputCurrent(self, channel = 1):
        return self.read_value(1020, MeParType.FLOAT32, channel)

    def TEC_ActualOutputVoltage(self, channel = 1):
        return self.read_value(1021, MeParType.FLOAT32, channel)

    def TEC_PIDLowerLimitation(self, channel = 1):
        return self.read_value(1030, MeParType.FLOAT32, channel)

    def TEC_PIDUpperLimitation(self, channel = 1):
        return self.read_value(1031, MeParType.FLOAT32, channel)

    def TEC_PIDControlVariable(self, channel = 1):
        return self.read_value(1032, MeParType.FLOAT32, channel)

    def TEC_ObjectSensorRawADCValue(self, channel = 1):
        return self.read_value(1040, MeParType.INT32, channel)

    def TEC_SinkSensorRawADCValue(self, channel = 1):
        return self.read_value(1041, MeParType.INT32, channel)

    def TEC_ObjectSensorResistance(self, channel = 1):
        return self.read_value(1042, MeParType.FLOAT32, channel)

    def TEC_SinkSensorResitance(self, channel = 1):
        return self.read_value(1043, MeParType.FLOAT32, channel)

    def TEC_SinkSensorTemperature(self, channel = 1):
        return self.read_value(1044, MeParType.FLOAT32, channel)

    def TEC_FirmwareVersion(self, channel = 1):
        return self.read_value(1050, MeParType.INT32, channel)

    def TEC_FirmwareBuildNumber(self, channel = 1):
        return self.read_value(1051, MeParType.INT32, channel)

    def TEC_HardwareVersion(self, channel = 1):
        return self.read_value(1052, MeParType.INT32, channel)

    def TEC_SerialNumber(self, channel = 1):
        return self.read_value(1053, MeParType.INT32, channel)

    def TEC_DriverInputVoltage(self, channel = 1):
        return self.read_value(1060, MeParType.FLOAT32, channel)

    def TEC_MedVInternalSupply(self, channel = 1):
        return self.read_value(1061, MeParType.FLOAT32, channel)

    def TEC_3VInternalSupply(self, channel = 1):
        return self.read_value(1062, MeParType.FLOAT32, channel)

    def TEC_BasePlateTemperature(self, channel = 1):
        return self.read_value(1063, MeParType.FLOAT32, channel)

    def TEC_ErrorNumber(self, channel = 1):
        return self.read_value(1070, MeParType.INT32, channel)

    def TEC_ErrorInstance(self, channel = 1):
        return self.read_value(1071, MeParType.INT32, channel)

    def TEC_ErrorParameter(self, channel = 1):
        return self.read_value(1072, MeParType.INT32, channel)

    def TEC_ParallelActualOutputCurrent(self, channel = 1):
        return self.read_value(1090, MeParType.FLOAT32, channel)

    def TEC_DriverStatus(self, channel = 1):
        return self.read_value(1080, MeParType.INT32, channel)

    def TEC_ParameterSystemFlashStatus(self, channel = 1):
        return self.read_value(1081, MeParType.INT32, channel)

    def TEC_FanRelativeCoolingPower(self, channel = 1):
        return self.read_value(1100, MeParType.FLOAT32, channel)

    def TEC_FanNominalFanSpeed(self, channel = 1):
        return self.read_value(1101, MeParType.FLOAT32, channel)

    def TEC_FanActualFanSpeed(self, channel = 1):
        return self.read_value(1102, MeParType.FLOAT32, channel)

    def TEC_FanActualPwmLevel(self, channel = 1):
        return self.read_value(1103, MeParType.FLOAT32, channel)

    def TEC_TemperatureIsStable(self, channel = 1):
        return self.read_value(1200, MeParType.INT32, channel)
    ...
    def TEC_MeasHighestResistance(self, channel = 1):
        return self.read_value(4031, MeParType.FLOAT32, channel)

    def TEC_MeasTempAtLowestResistance(self, channel = 1):
        return self.read_value(4032, MeParType.FLOAT32, channel)

    def TEC_MeasTempAtHighestResistance(self, channel = 1):
        return self.read_value(4033, MeParType.FLOAT32, channel)
    ...
    def TEC_MeasHighestResistance(self, channel = 1):
        return self.read_value(5041, MeParType.FLOAT32, channel)

    def TEC_MeasTempAtLowestResistance(self, channel = 1):
        return self.read_value(5042, MeParType.FLOAT32, channel)

    def TEC_MeasTempAtHighestResistance(self, channel = 1):
        return self.read_value(5043, MeParType.FLOAT32, channel)
    ...
    def TEC_AtmTuningParameter2D(self, channel = 1):
        return self.read_value(51011, MeParType.FLOAT32, channel)

    def TEC_AtmTuningParameterKu(self, channel = 1):
        return self.read_value(51012, MeParType.FLOAT32, channel)

    def TEC_AtmTuningParameterTu(self, channel = 1):
        return self.read_value(51013, MeParType.FLOAT32, channel)

    def TEC_AtmPIDParameterKp(self, channel = 1):
        return self.read_value(51014, MeParType.FLOAT32, channel)

    def TEC_AtmPIDParameterTi(self, channel = 1):
        return self.read_value(51015, MeParType.FLOAT32, channel)

    def TEC_AtmPIDParameterTd(self, channel = 1):
        return self.read_value(51016, MeParType.FLOAT32, channel)

    def TEC_AtmSlowPIParameterKp(self, channel = 1):
        return self.read_value(51022, MeParType.FLOAT32, channel)

    def TEC_AtmSlowPIParameterTi(self, channel = 1):
        return self.read_value(51023, MeParType.FLOAT32, channel)

    def TEC_AtmPIDDPartDamping(self, channel = 1):
        return self.read_value(51024, MeParType.FLOAT32, channel)

    def TEC_AtmCoarseTempRamp(self, channel = 1):
        return self.read_value(51017, MeParType.FLOAT32, channel)

    def TEC_AtmProximityWidth(self, channel = 1):
        return self.read_value(51018, MeParType.FLOAT32, channel)

    def TEC_AtmTuningStatus(self, channel = 1):
        return self.read_value(51020, MeParType.INT32, channel)

    def TEC_AtmTuningProgress(self, channel = 1):
        return self.read_value(51021, MeParType.FLOAT32, channel)
